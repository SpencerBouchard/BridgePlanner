...
<head>
    ...
    <link href="joinGamesPage.css" rel="stylesheet" type="text/css">
</head>
...
<button class="button backBtn" id="backBtn" onClick="window.location='gamesOptionsPage.html'">Back</button>

<!-- This is the header of the current games -->
                    ...
                    while ($row = $result-> fetch_assoc()) {
                        ...
                        if ($result2-> num_rows > 0) {
                            while ($row2 = $result2-> fetch_assoc()) {
                                ...
                                echo "<form action=\"joinGame.php\" method=\"post\">";
                                //delete game button
