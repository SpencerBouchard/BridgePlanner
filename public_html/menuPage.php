...
<body>
        ...
        <div class= "top">
            ...
            <a href="profile.php"><button class= "button profileBtn"><i class="fas fa-user-circle"></i><br>Profile</button></a>
            <!-- This is the header of the menu page -->
            <h1><center>Bridge Messenger</center></h1>
            <!-- This button logs the user out of the app and takes them to the "logoutPage" page when clicked on -->
            <a href="logoutPage.php"><button class = "button logoutBtn"><i class="fas fa-sign-out-alt"></i><br>Logout</button></a>
        </div>
