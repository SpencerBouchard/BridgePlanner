...
/**
    ...
    * This code is specifically linked to Margots desktop version but is not different from the authenticate for the mobile version.
...
if ($stmt->num_rows > 0) {
	...
	if (password_verify($_POST['password'], $password)) {
		...
		header('Location: menuPageLaptop.php');
	} else {
