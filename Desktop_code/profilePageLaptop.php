<!-- The PHP was done by Aida Sultan (A00432414) -->
...
<head>
    ...
    <link href="profilePageLaptop.css" rel="stylesheet" type="text/css">
...
<!-- This div is for the buttons of the page -->
        <div>
            <!-- This button takes the user to the "menuPage" page when clicked on -->
            <button id="homeBtn" onclick="window.location='menuPageLaptop.php'"><i class="fas fa-home"></i>Home</button>
            <!-- This button logs the user out of the app and takes them to the "logoutPage" page when clicked on -->
            <button id="logoutBtn"onclick="window.location='logoutPageLaptop.php'"><i class="fas fa-sign-out-alt"></i>Logout</button>
            <h1>Bridge Profile Page</h1>
        </div>

        <!-- This div is for the user's information display -->
    <div>
